...
```
> Created a vector with "A", "B", "C" using c()
...
> It outputs a new vector with the two vectors next to each other, i.e. A, B, C, A, B, C.
...
> Nothing happens to the type, it outputs an error: "non-numeric argument to binary operator".
